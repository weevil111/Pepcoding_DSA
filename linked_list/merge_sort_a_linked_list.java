...
public class Main {
  ...
  public static class LinkedList {
	...
	public static Node midOfList(Node head, Node tail){
    ...
    public static LinkedList mergeSort(Node head, Node tail){
      if(head == null){
      	...
      	Node mid = midOfList(head, tail);
      	LinkedList sortedList1 = mergeSort(head, mid);
      	LinkedList sortedList2 = mergeSort(mid.next, tail);
